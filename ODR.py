...
arquivos = ['Ganho_1_Tomada_1',
            'Ganho_1_Tomada_2',
            'Ganho_10_Tomada_1_Parte_1',
            'Ganho_10_Tomada_1_Parte_2',
            'Ganho_10_Tomada_2_Parte_1',
            'Ganho_10_Tomada_1_Parte_2',]

arquivos1 = ['Ganho_1_Tomada_1']
...
for j in range (len(arquivos1)):
    ...
    plt.xlabel(' θ ( °)')
    plt.title('Gráfico da Intensidade em função de  θ para Ganho 1 e Tomada 1')